...
import fr.pgah.java.unbrco.model.Arc;
...
public class OutilFormeArc extends Outil {

  private Forme forme;

  public OutilFormeArc(EditeurDeFormes editeur, JComponent parent) {
  ...
  protected void creerBouton(JComponent parent) {
    bouton = new JButton("Forme en Arc");
  ...
  public void pressDansZoneDessin(MouseEvent e) {
    forme = new Arc(e.getPoint(), editeur.getMidiSynth());
  ...
  private class OutilFormeClicHandler implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      editeur.setOutilActif(OutilFormeArc.this);
    }
  }
}
